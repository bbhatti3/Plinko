...
Qlinqo.Setup = function (playfieldLayer, foregroundLayer, backgroundLayer, debugLayer, statusLayer, gameOverLayer) {
	...
	backgroundLayer.addChild(new Qlinqo.NeonText(scaledWidth/2, 0.4, "Tap Here", 26, "center", "#008000", "#008000"));
	...
	backgroundLayer.addChild(new Qlinqo.NeonText(scaledWidth/2, scaledHeight/2, "Ethics@Work", 50));
